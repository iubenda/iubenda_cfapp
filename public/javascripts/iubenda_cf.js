CloudFlare.define("iubenda",
    ...
    {		
		function addBadge(){
			...
			var embeddedCode = "<a href=\""+protocol+"//staging.mater.iubenda.com/privacy-policy/1/"+_config.domain_id+"\" class=\"iubenda-white iubenda-embed no-brand iub-anchor\" title=\"Privacy Policy\">Privacy Policy</a><script type=\"text/javascript\">(function (w,d) {var loader = function () {var s = d.createElement(\"script\"), tag = d.getElementsByTagName(\"script\")[0]; s.src = \""+protocol+"//staging.mater.iubenda.com/assets/cdn/iubenda.js\"; tag.parentNode.insertBefore(s,tag);}; loader();})(window, document);</script>";
			console.log("embedding code: "+embeddedCode);
			$("body").append(embeddedCode);
			console.log("added!");
		}
		function lookForBadge(){
			console.log("loaded version 0.0.13.")
